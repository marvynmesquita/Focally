      ...
      <div className="w-full max-w-4xl z-10">
        {!mode ? (
          <div className="flex flex-col items-center">
            <h1 className="text-5xl md:text-7xl font-extrabold mb-4 tracking-[-0.04em] text-transparent bg-clip-text bg-gradient-to-br from-accent-primary via-accent-primary/80 to-white drop-shadow-[0_4px_24px_rgba(83,58,253,0.3)]">
              Focally
            </h1>
            <p className="text-gray-400 mb-12 text-lg font-medium tracking-tight">O portal para o foco profundo</p>
          ...
          <div className="w-full flex flex-col items-center">
            <button
              ...
              className="self-start mb-8 text-gray-400 hover:text-white flex items-center gap-2 transition-colors font-semibold tracking-tight uppercase text-xs"
            >
